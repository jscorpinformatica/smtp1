...
class PHPMailer
{
    ...
    public function html2text($html, $advanced = false)
    {
		...
		// $return = preg_replace('/<(head|title|style|script)[^>]*>.*?<\/\\1>/si', '', $html);
		// $return = strip_tags($return);
		// $return = trim($return);
		// $return = html_entity_decode($return , ENT_QUOTES, $this->CharSet);
		// #$return = iconv("UTF-8", "ISO-8859-1//IGNORE", $return);
		// $return = mb_convert_encoding($return, 'ISO-8859-1//IGNORE', mb_detect_encoding($return));
